...
In this chapter we have the implementation and the architecture of \ac{sems}, showing the main system modules,
...
\newParagraph
We started to test and compare between different frameworks, the comparison was made between Express.js, Hapi.js, Sails.js and meteor.js; the main goal was to have a stable
...
\newParagraph
The deployment finally was done using Meteor's build tool, that allows bundling the application and produces bundle that can run
